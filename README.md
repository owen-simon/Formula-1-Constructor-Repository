...
This dataset includes constructor-level seasonal performance data from the Formula One World Championship spanning 2002 to the present.
...
**Processed Data**
- `Feature_Engineered/`: Output directory containing processed datasets generated by Feature_Engineering.py, including model-ready training and test sets.
